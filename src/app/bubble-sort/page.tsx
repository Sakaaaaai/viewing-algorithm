...
const BubbleSort = () => {
    ...
    for (let i = 0; i < n - 1; i++) {
      ...
      for (let j = 0; j < n - i - 1; j++) {
        ...
        steps.push({
          array: [...arrCopy],
          highlightedLines: [6],
          description: `${arrCopy[j]} と ${arrCopy[j + 1]} を比較`,
          variables: { i, j, n },
          comparing: [j, j + 1],
          phase: "comparison"
        });
        ...
        if (arrCopy[j] > arrCopy[j + 1]) {
          steps.push({
            ...
            description: `${arrCopy[j]} と ${arrCopy[j + 1]} を交換`,
            variables: { i, j, n },
            swapping: [j, j + 1],
            phase: "swap-start"
          });
  ...
  useEffect(() => {
    setSortingSteps(generateBubbleSortSteps(array));
  }, [array]);
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-blue-200 dark:from-blue-900 dark:to-blue-800 py-6">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h1 className="text-4xl font-bold text-blue-600 dark:text-blue-400 text-center">バブルソート</h1>
        </motion.div>
        ...
        >
          <Card className="bg-white dark:bg-gray-800 shadow-lg">
            <CardHeader>
              <CardTitle className="text-2xl text-blue-600 dark:text-blue-400">バブルソートとは</CardTitle>
              <CardDescription>単純だが非効率なソートアルゴリズムの代表例</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="flex items-start">
                <div className="space-y-4">
                  <p>
                    バブルソートは、隣接する要素を繰り返し比較し、必要に応じて交換することで配列をソートする単純なアルゴリズムです。
                  </p>
                  <p>
                    各パスで最大の要素が正しい位置に「浮かび上がる」様子が泡（バブル）のように見えることから、この名前が付けられました。
                  </p>
                  <div>
                    <h3 className="font-semibold mb-2">アルゴリズムの特徴：</h3>
                    <ul className="list-disc list-inside space-y-1">
                      <li>実装が簡単で直感的に理解しやすい</li>
                      <li>小規模なデータセットや、ほぼソートされているデータに対しては効率的</li>
          ...
          >
            <Card className="h-full bg-white dark:bg-gray-800 shadow-lg">
              <CardHeader>
                ...
                <CardDescription>バブルソートのコードと現在の実行行</CardDescription>
              </CardHeader>
              <CardContent>
